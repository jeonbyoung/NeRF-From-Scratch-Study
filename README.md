...
| :---: | :---: |
| ![PE Only Result](이미지경로_PE_ONLY_넣으세요) | ![PE + Raw Result](이미지경로_PE_RAW_넣으세요) |
...
| :---: | :---: |
| ![2 Layers](이미지경로_2_LAYER_넣으세요) | ![4 Layers](이미지경로_4_LAYER_넣으세요) |
...
| :---: | :---: |
| ![Low Samples](이미지경로_LOW_SAMPLE_넣으세요) | ![High Samples](이미지경로_HIGH_SAMPLE_넣으세요) |

### 3-4. 하이퍼파라미터 튜닝: 학습률 (Learning Rate)
* **LR = 1e-3:**
* **LR = 5e-3:** LR을 5배 늘렸을 때, 학습 속도는 어떻게 달라질 것인가?
  **이 정도는 큰 차이가 없었습니다** 

| LR = 1e-3 | LR = 5e-3 |
| :---: | :---: |
| ![High LR](이미지경로_HIGH_LR_넣으세요) | ![Optimized LR](이미지경로_OPT_LR_넣으세요) |
...
<div align="center">
  <img src="이미지경로_ORIGINAL_NERF_실패_넣으세요" width="60%">
...
* **수식 유도 및 논문 리뷰:** * [나의 노션 페이지 (Click Here)](여기에_노션링크_넣으세요) - NeRF 논문 읽고 리뷰한 내용.
...
# 2. 학습 시작 (Tiny NeRF 설정)
python main.py --lr 5e-4 --n_rays 1024
